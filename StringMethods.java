...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("Conatins check 1" + str.contains("is"));
		System.out.println("Contains check 2" + str.contains("best"));
		System.out.println("Starts with check 1" + str.startsWith("This"));
		System.out.println("Ends with check 2" + str.endsWith("Bear"));
